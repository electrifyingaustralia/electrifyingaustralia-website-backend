            ...
            <div class="flex flex-col lg:!flex-row gap-6">
                                    ...
                                    @forelse($types as $type)
                                        <tr>
                                            ...
                                            <td class="px-14 py-4 flex justify-end gap-x-2">
                                                <a href="{{ route('admin.faq-type.edit', $type->id) }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="2" class="px-6 py-4 text-center font-medium text-gray-700">
                                                ...
                                                <span class="text-gray-500">Create your first faq type to get
                                                    started!</span>
                                            </td>
                                        </tr>
                                    @endforelse
                ...
                <div class="w-full lg:!w-1/3">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <form
                            action="{{ isset($typeToEdit) ? route('admin.faq-type.update', $typeToEdit->id) : route('admin.faq-type.store') }}"
                            method="POST">
                            @csrf
                            @if (isset($typeToEdit))
                                @method('PUT')
