                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2">Create New Event</span>
                        </div>
                    </li>
                </ol>
                    ...
                    <div class="w-full">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <!-- Media Selection -->
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Event Media</label>
