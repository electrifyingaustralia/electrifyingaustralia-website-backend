                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2">Create New Product</span>
                        </div>
                    </li>
                </ol>
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" required
                                        ...
                                        placeholder="Enter product name" failed remove="name" />
                                </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow">
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <select name="brand_id" id="brand_id" remove="brand_id"
                                    ...
                                    <div failed="brand_id"></div>
                                </div>
                                <div>
                                    <label for="product_type_id"
                                        class="block text-sm font-medium text-gray-700 mb-1">Product Type <span
                                            class="text-red-600 font-bold">*</span></label>
                                    <select name="product_type_id" id="product_type_id" remove="product_type_id"
                                        class="w-full p-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500"
                                        required>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" id="meta_title" name="meta_title"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter meta title for search engines" value="{{ old('meta_title') }}">
                                    @error('meta_title')
