                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page" class="hidden lg:block">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ml-1 text-lg font-medium text-gray-500 md:ml-2 truncate lg:!max-w-[15rem]">{{ $product->name }}</span>
                        </div>
                    </li>
                </ol>
                ...
                <div class="flex flex-col lg:!flex-row gap-6">
                    <div class="w-full lg:!w-2/3">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    <label for="model_number" class="block text-sm font-medium text-gray-700 mb-2">Model
                                        Number <span class="text-red-600 font-bold">*</span></label>
                                    <input type="text" id="model_number" name="model_number" required failed
                                        remove="model_number"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                ...
                                <div>
                                    ...
                                    <textarea name="short_description"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter product sort description...">{{ old('short_description', $product->short_description) }}</textarea>
                                ...
                                <div>
                                    ...
                                    <div id="selected-logo-info"
                                        class="mt-3 p-3 bg-gray-50 rounded-lg {{ $product->media ? '' : 'hidden' }}">
                                        @if ($product->media)
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center space-x-3">
                                                    @if ($product->media->mime_type && str_starts_with($product->media->mime_type, 'image/'))
                                                        <img id="selected-logo-preview" src="{{ $product->media->url }}"
                    ...
                    <div class="w-full lg:!w-1/3">
                        <div class="bg-white p-6 rounded-lg shadow">
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    <label for="brand_id" class="block text-sm font-medium text-gray-700 mb-1">Select
                                        Brand <span class="text-red-600 font-bold">*</span></label>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea id="meta_description" name="meta_description" rows="2"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter meta description for search engines">{{ old('meta_description', $product->meta_description ?? '') }}</textarea>
