                    ...
                    <div class="flex gap-4">
                        <div class="flex-1">
                            <input type="text" name="search" value="{{ request('search') }}"
                                placeholder="Search products..." class="w-full p-2 border !border-gray-300 rounded-lg">
                        </div>
                        ...
                        <div class="min-w-1/5">
                            <select name="type" id="type-filter" class="w-full p-2 border border-gray-300 rounded-lg"
                            ...
                            @forelse($products  as $product)
                                <tr>
                                    <td class="px-6 py-4 font-medium text-gray-900 max-w-[2rem]">
                                        <div class="flex items-center">
                                            @if (optional($product->media)->url)
                                                <img src="{{ optional($product->media)->url }}"
                                                    alt="{{ $product->media->alt_name ?? $product->name }}"
