    ...
    <div class="flex-1 p-6">
        <div class="max-w-5xl mx-auto">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('admin.product.all') }}"
                                class="ml-1 text-lg font-medium text-gray-500 hover:!text-teal-600 md:ml-2">Products</a>
                        </div>
                    </li>
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2">Assign Images to Product</span>
                        </div>
                    </li>
                </ol>
                <a href="{{ route('admin.product.all') }}"
            ...
            <div class="bg-white p-6 rounded-lg shadow mb-6">
                <h2 class="text-xl font-semibold mb-4">Assign Images to: {{ $product->name }}</h2>

                <form id="assign-images-form" action="{{ route('admin.product.store-images', $product->id) }}"
                    method="POST">
                    @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadProductImages() {
                ...
                $.ajax({
                    url: '{{ route('admin.product.images', $product->id) }}',
                    method: 'GET',
