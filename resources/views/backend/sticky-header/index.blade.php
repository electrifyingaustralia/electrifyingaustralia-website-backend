            ...
            <div class="flex flex-col lg:!flex-row gap-6">
                                    ...
                                    @forelse($headers as $header)
                                        <tr>
                                            ...
                                            <td class="px-14 py-4 flex justify-end gap-x-2">
                                                <a href="{{ route('admin.sticky-header.edit', $header->id) }}"
                                                ...
                                                <button class="text-red-500 hover:text-red-700 p-1 rounded hover:bg-red-50"
                                                    type="button" onclick="confirmDelete({{ $header->id }})">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="w-full lg:!w-1/3">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <form
                            action="{{ isset($headerToEdit) ? route('admin.sticky-header.update', $headerToEdit->id) : route('admin.sticky-header.store') }}"
                            method="POST">
                            @csrf
                            ...
                            <div class="mb-4">
                                <label for="title" class="block text-sm font-medium text-gray-700 mb-1">Sticky Header
                                    <span class="text-red-600 font-bold">*</span></label>
                                <input type="text" id="title" name="title"
                                    value="{{ old('name', $headerToEdit->title ?? '') }}"
