...
@section('contents')
    <div class="flex-1 p-6">
        <div class="max-w-5xl mx-auto">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page" class="hidden lg:block">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ml-1 text-lg font-medium text-gray-500 md:ml-2 truncate lg:!max-w-[15rem]">{{ $team->name }}</span>
                        </div>
                    </li>
                </ol>
            ...
            <form id="team-form" action="{{ route('admin.teams.update', $team->id) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="email" id="email" name="email"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        value="{{ old('email', $team->email) }}" placeholder="Enter team member email" />
                                    @error('email')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="phone" name="phone"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        value="{{ old('phone', $team->phone) }}" placeholder="Enter team member phone" />
                                    @error('phone')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="description"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">{!! old('description', $team->description) !!}</textarea>
                                ...
                                <div>
                                    ...
                                    <div id="selected-logo-info"
                                        class="mt-3 p-3 bg-gray-50 rounded-lg {{ $team->media ? '' : 'hidden' }}">
                                        @if ($team->media)
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center space-x-3">
                                                    @if ($team->media->mime_type && str_starts_with($team->media->mime_type, 'image/'))
                                                        <img id="selected-logo-preview" src="{{ $team->media->url }}"
                                                    ...
                                                    <div>
                                                        <p id="selected-logo-name" class="text-sm font-medium">
                                                            {{ $team->media->original_name }}</p>
                                                        @if ($team->media->alt_name)
                                                            <p class="text-xs text-teal-600 font-medium">Alt Name:
                                                                {{ $team->media->alt_name }}</p>
                                                        @endif
                                                        <p id="selected-logo-size" class="text-xs text-gray-500">
                                                            {{ formatFileSize($team->media->file_size) }}</p>
                                                    </div>
                                                </div>
