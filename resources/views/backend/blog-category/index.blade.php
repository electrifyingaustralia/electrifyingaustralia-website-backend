            ...
            <div class="flex flex-col lg:!flex-row gap-6">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="2" class="px-6 py-4 text-center font-medium text-gray-700">
                                                ...
                                                <span class="text-gray-500">Create your first blog category to get
                                                    started!</span>
                                            </td>
                                        </tr>
                                    @endforelse
                ...
                <div class="w-full lg:!w-1/3">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <form
                            action="{{ isset($categoryToEdit) ? route('admin.blog-category.update', $categoryToEdit->id) : route('admin.blog-category.store') }}"
                            method="POST">
                            @csrf
