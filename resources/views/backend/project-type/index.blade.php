...
@section('contents')
            ...
            <div class="flex flex-col lg:!flex-row gap-6">
                                    ...
                                    @forelse($types as $type)
                                        <tr>
                                            ...
                                            <td class="px-14 py-4 flex justify-end gap-x-2">
                                                <a href="{{ route('admin.project-type.edit', $type->id) }}"
                                                ...
                                                <button class="text-red-500 hover:text-red-700 p-1 rounded hover:bg-red-50"
                                                    type="button" onclick="confirmDelete({{ $type->id }})">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="2" class="px-6 py-4 text-center font-medium text-gray-700">
                                                ...
                                                <span class="text-gray-500">Create your first project type to get
                                                    started!</span>
                                            </td>
                                        </tr>
                                    @endforelse
                ...
                <div class="w-full lg:!w-1/3">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <form
                            action="{{ isset($typeToEdit) ? route('admin.project-type.update', $typeToEdit->id) : route('admin.project-type.store') }}"
                            method="POST">
                            @csrf
                            @if (isset($typeToEdit))
                                @method('PUT')
    ...
    <div id="delete-modal" class="fixed inset-0 bg-black/30 bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white p-6 rounded-lg w-full max-w-md">
            ...
            <p class="text-gray-600 mb-6">Are you sure you want to delete this sticky header? This action cannot be undone.
            </p>
