        ...
        <div
            ...
            <div
                ...
                <div
                    ...
                    <a href="index.html">
                        <span class="hidden"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" data-lucide="chevrons-left"
                                class="lucide lucide-chevrons-left w-5 h-5 group-data-[sidebar-size=sm]:hidden">
                    ...
                    <div class="relative flex items-center dropdown h-header">
                        <button type="button"
                            ...
                            <div class="bg-gray-100 rounded-full">
                                ...
                                @if (auth()->guard('admin')->user()->media_url)
                                    <img class="w-[37.5px] h-[37.5px] rounded-full"
                                        src="{{ auth()->guard('admin')->user()->media_url }}">
                                @else
                                    <div
                                        class="w-[37.5px]  h-[37.5px] flex items-center justify-center bg-gray-100 rounded-full">
                        ...
                        <div class="absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem] dark:bg-zink-600"
                            ...
                            <a href="{{ route('admin.users.edit', auth()->guard('admin')->id()) }}"
                                ...
                                <div class="relative inline-block shrink-0">
                                    <div class="rounded bg-slate-100 dark:bg-zink-500">
                                        ...
                                        @else
                                            <div
                                                class="h-10 w-10 flex items-center justify-center bg-gray-100 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <div>
                                    <h6 class="mb-1 text-15">{{ auth()->guard('admin')->user()->name }}</h6>
                                    <p class="text-slate-500 dark:text-zink-300 leading-1">
                            ...
                            <ul>
                                <li>
                                    <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                        href="{{ route('admin.users.edit', auth()->guard('admin')->id()) }}"><svg
                                ...
                                <li>
                                    <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                        href="{{ route('admin.users.change-password') }}">
                                ...
                                {{-- <li>
                                    <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                        href="apps-mailbox.html"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                {{-- <li>
                                    <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                        href="apps-chat.html"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                            data-lucide="messages-square"
                                            class="lucide lucide-messages-square inline-block size-4 ltr:mr-2 rtl:ml-2">
                                ...
                                {{-- <li>
                                    <a class="block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500"
                                        href="pages-pricing.html"><svg xmlns="http://www.w3.org/2000/svg"
