            ...
            <div class="w-full">
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden mb-6">
                    <div class="px-6 py-5 border-b border-gray-200">
                        <h3 class="text-lg font-normal text-gray-900">Question : <span
                                class="font-medium">{{ $question->question }}</span></h3>
                    </div>
                    {{-- <div class="px-6 py-5">
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-200">
                        <div class="flex justify-between items-center">
                            ...
                            <p class="text-sm font-medium text-gray-600 mt-1">Total options:
                                {{ $question->options->count() }}</p>
                        </div>
                    </div>
                    <div class="px-6 py-5">
