...
@section('contents')
            ...
            <div class="flex flex-col lg:!flex-row gap-6">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="2" class="px-6 py-4 text-center font-medium text-gray-700">
                                                ...
                                                <span class="text-gray-500">Create your first project category to get
                                                    started!</span>
                                            </td>
                                        </tr>
                                    @endforelse
                ...
                <div class="w-full lg:!w-1/3">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <form
                            action="{{ isset($categoryToEdit) ? route('admin.project-category.update', $categoryToEdit->id) : route('admin.project-category.store') }}"
                            method="POST">
                            @csrf
    ...
    <div id="delete-modal" class="fixed inset-0 bg-black/30 bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white p-6 rounded-lg w-full max-w-md">
            ...
            <p class="text-gray-600 mb-6">Are you sure you want to delete this project category? This action cannot be
                undone.</p>
