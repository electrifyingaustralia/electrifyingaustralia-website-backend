    ...
    <div class="flex-1 p-6">
        <div class="max-w-5xl mx-auto">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('admin.project.all') }}"
                                class="ml-1 text-lg font-medium text-gray-极0 hover:!text-teal-600 md:ml-2">Projects</a>
                        </div>
                    </li>
            ...
            <div class="bg-white p-6 rounded-lg shadow mb-6">
                ...
                <form id="assign-images-form" action="{{ route('admin.project.store-images', $project->id) }}"
                    method="POST">
                    @csrf
        ...
        $(document).ready(function() {
            ...
            function renderMediaLibrary(mediaItems, append = false) {
                ...
                $.each(mediaItems, function(index, media) {
                    ...
                    html += `
                    <div class="media-item bg-gray-100 rounded-lg overflow-hidden cursor-pointer transition-all hover:shadow-md ${isSelected ? 'selected' : ''}" data-media-id="${media.id}">
