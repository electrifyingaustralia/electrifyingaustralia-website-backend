...
@section('contents')
    <div class="flex-1 p-6">
        <div class="max-w-5xl mx-auto">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2">Create New Project</span>
                        </div>
                    </li>
                </ol>
            ...
            <form id="project-form" action="{{ route('admin.project.store') }}" method="POST"
                        ...
                        <div class="bg-white p-6 rounded-lg shadow">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="title" name="title" required failed remove="title"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="subtitle" name="subtitle" required failed remove="subtitle"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="project_type_id" id="project_type_id"
                                        class="w-full p-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500"
                                        required remove="project_type_id">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="extra_info_1" name="extra_info_1"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter solar panel" value="{{ old('extra_info_1') }}" />
                                    @error('extra_info_1')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="extra_info_2" name="extra_info_2"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter solar panel" value="{{ old('extra_info_2') }}" />
                                    @error('extra_info_2')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="extra_info_3" name="extra_info_3"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter solar panel" value="{{ old('extra_info_3') }}" />
                                    @error('extra_info_3')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="extra_info_4" name="extra_info_4"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter solar panel" value="{{ old('extra_info_4') }}" />
                                    @error('extra_info_4')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" id="extra_info_5" name="extra_info_5"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter solar panel" value="{{ old('extra_info_5') }}" />
                                    @error('extra_info_5')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
