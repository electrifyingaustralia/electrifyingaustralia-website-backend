...
@section('contents')
    <div class="flex-1 p-6">
        <div class="max-w-5xl mx-auto">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2">Edit Project</span>
                        </div>
                    </li>
                    <li aria-current="page" class="hidden lg:block">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ml-1 text-lg font-medium text-gray-500 md:ml-2 truncate lg:!max-w-[15rem]">{{ $project->title }}</span>
                        </div>
                    </li>
                </ol>
            ...
            <form id="project-form" action="{{ route('admin.project.update', $project->id) }}" method="POST"
                ...
                <div class="flex flex-col lg:!flex-row gap-6">
                    <div class="w-full lg:!w-2/3">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    <label for="title" class="block text-sm font-medium text-gray-700 mb-2">Project title
                                ...
                                <div>
                                    <label for="subtitle" class="block text-sm font-medium text-gray-700 mb-2">Project
                                        Subtitle <span class="text-red-600 font-bold">*</span></label>
                                ...
                                <div>
                                    <label for="location" class="block text-sm font-medium text-gray-700 mb-2">Project
                                        Location</label>
                                ...
                                <!-- Media Selection -->
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Project Media <span
                                    ...
                                    <div class="flex flex-col sm:flex-row gap-4">
                                        ...
                                        <div class="w-32 h-32 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-gray-50"
                                            id="logo-preview">
                                            @if ($project->media)
                                                @if ($project->media->mime_type && str_starts_with($project->media->mime_type, 'image/'))
                                                    <img src="{{ $project->media->url }}" alt="{{ $project->title }}"
                                                        class="w-full h-full object-cover rounded-lg">
                                                @elseif($project->media->mime_type && str_starts_with($project->media->mime_type, 'video/'))
                                                    <div
                                        ...
                                        <div class="flex flex-col justify-center gap-2">
                                            ...
                                            <input type="hidden" id="selected-media-id" name="media_id"
                                                value="{{ old('media_id', $project->media_id) }}">
                                        </div>
                                    </div>

                                    <!-- Selected Media Info -->
                                    <div id="selected-logo-info"
                                        class="mt-3 p-3 bg-gray-50 rounded-lg {{ $project->media ? '' : 'hidden' }}">
                                        @if ($project->media)
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center space-x-3">
                                                    @if ($project->media->mime_type && str_starts_with($project->media->mime_type, 'image/'))
                                                        <img id="selected-logo-preview" src="{{ $project->media->url }}"
                                                    ...
                                                    <div>
                                                        <p id="selected-logo-name" class="text-sm font-medium">
                                                            {{ $project->media->original_name }}</p>
                                                        @if ($project->media->alt_name)
                                                            <p class="text-xs text-teal-600 font-medium">Alt Name:
                                                                {{ $project->media->alt_name }}</p>
                                                        @endif
                                                        <p id="selected-logo-size" class="text-xs text-gray-500">
                                                            {{ formatFileSize($project->media->file_size) }}</p>
                                                    </div>
                                                </div>
                    ...
                    <div class="w-full lg:!w-1/3">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    <label for="category" class="block text-sm font-medium text-gray-700 mb-1">
                                        Select Category <span class="text-red-600 font-bold">*</span>
                                    </label>
                                    ...
                                    <select name="category" id="category"
                                        ...
                                        <option value="residential"
                                            {{ old('category', $project->category ?? '') == 'residential' ? 'selected' : '' }}>
                                            Residential
                                        </option>

                                        <option value="commercial"
                                            {{ old('category', $project->category ?? '') == 'commercial' ? 'selected' : '' }}>
                                            Commercial
                                        </option>
                                    </select>
                                ...
                                <div>
                                    <label for="project_type_id"
                                        class="block text-sm font-medium text-gray-700 mb-1">Select Type <span
                                            class="text-red-600 font-bold">*</span></label>
                                ...
                                <div>
                                    <label for="is_solution" class="block text-sm font-medium text-gray-700 mb-2">Is
                                        Solution</label>
                                    <select name="is_solution" id="is_solution" required
                                        class="w-full p-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500">
                                        <option value="0"
                                            {{ old('is_solution', $project->is_solution) == 0 ? 'selected' : '' }}>No
                                        </option>
                                        <option value="1"
                                            {{ old('is_solution', $project->is_solution) == 1 ? 'selected' : '' }}>Yes
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="mt-3 bg-white p-6 rounded-lg shadow">
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    <label for="extra_info_1" class="block text-sm font-medium text-gray-700 mb-2">Extra
                                        Info 1</label>
                                    <input type="text" id="extra_info_1" name="extra_info_1"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter solar panel"
                                        value="{{ old('extra_info_1', $project->extra_info_1) }}" />
                                    @error('extra_info_1')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    <label for="extra_info_2" class="block text-sm font-medium text-gray-700 mb-2">Extra
                                        Info 2</label>
                                    <input type="text" id="extra_info_2" name="extra_info_2"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter solar panel"
                                        value="{{ old('extra_info_2', $project->extra_info_2) }}" />
                                    @error('extra_info_2')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    <label for="extra_info_3" class="block text-sm font-medium text-gray-700 mb-2">Extra
                                        Info 3</label>
                                    <input type="text" id="extra_info_3" name="extra_info_3"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter solar panel"
                                        value="{{ old('extra_info_3', $project->extra_info_3) }}" />
                                    @error('extra_info_3')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    <label for="extra_info_4" class="block text-sm font-medium text-gray-700 mb-2">Extra
                                        Info 4</label>
                                    <input type="text" id="extra_info_4" name="extra_info_4"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter solar panel"
                                        value="{{ old('extra_info_4', $project->extra_info_4) }}" />
                                    @error('extra_info_4')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    <label for="extra_info_5" class="block text-sm font-medium text-gray-700 mb-2">Extra
                                        Info 5</label>
                                    <input type="text" id="extra_info_5" name="extra_info_5"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                        placeholder="Enter solar panel"
                                        value="{{ old('extra_info_5', $project->extra_info_5) }}" />
                                    @error('extra_info_5')
                                        <p class="!text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
        ...
        $(document).ready(function() {
            ...
            @if ($project->media)
                selectedMedia = {
                    ...
                    name: '{{ $project->media->original_name }}',
                    size: {{ $project->media->file_size }},
                    alt_name: '{{ $project->media->alt_name }}',
                    file: null,
                    type: 'library'
                };
            @endif
