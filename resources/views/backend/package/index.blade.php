                    ...
                    @if ($packages->count() > 0)
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            @foreach ($packages as $package)
                                <div
                                    class="card bg-white rounded-xl overflow-hidden p-6 {{ $package->is_best_deal ? 'border-2 border-teal-500 ring-2 ring-teal-500/20' : '' }}">
                                    @if ($package->is_best_deal)
                                        <div
                                            class="absolute top-0 right-0 bg-teal-500 text-white px-3 py-1 text-xs font-bold rounded-bl-lg">
                                            Best Deal
                                        </div>
                                    @endif
                                    ...
                                    <div class="flex justify-between items-start">
                                        <div class="flex items-center">
                                            <div>
                                                ...
                                                <p class="text-gray-600 max-w-[18rem] line-clamp-3">{{ $package->subtitle }}
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mt-5 pt-4 border-t border-gray-100">
                                        ...
                                        <div class="flex flex-col pl-2 gap-2 text-sm">
                                            ...
                                            @if ($package->features->count() > 5)
                                                <p class="text-teal-600 text-xs">+{{ $package->features->count() - 5 }} more
                                                    features</p>
                                            @endif
                                        </div>
                                    </div>
