                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-1">
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="mb-4">
                                <img src="{{ $product->media_url }}" alt="Solar Panel" class="w-full h-48 object-scale-down rounded-lg">
                            </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <a href="{{ $product->product_link }}" target="_blank" class="text-teal-600 hover:text-teal-800 break-words">{{ $product->product_link }}</a>
                                </div>
                            </div>

                            <div class="mt-6 pt-4 border-t border-gray-200">
                                <a href="{{ route('admin.product.edit', $product->id) }}" class="w-full bg-teal-600 hover:bg-teal-700 text-white py-2 px-4 rounded-lg flex items-center justify-center mb-2">
