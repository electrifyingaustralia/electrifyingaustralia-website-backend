                        ...
                        <tr>
                            <td class="px-6 py-4 font-medium text-gray-900 max-w-[2rem]">
                                <div class="flex items-center">
                                    ...
                                    <img src="{{ $product->media_url }}" class="w-20 h-10 object-cover rounded">
                                    @else
                            ...
                            <td class="px-6 py-4 max-w-[15rem] truncate">{{ $product->title }}</td>
                            <td class="px-6 py-4 max-w-[15rem] truncate">{{ $product->subtitle }}</td>
                            <td class="px-6 py-4 max-w-[15rem] truncate">{{ $product->subtitle }}</td>
                            <td class="px-6 py-4 max-w-[15rem] truncate">{{ $product->subtitle }}</td>
