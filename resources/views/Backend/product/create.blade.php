                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <select name="is_featured" id="is_featured" class="w-full p-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500">
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    localStorage.setItem('toastr_success', response.message) || '{{ route('admin.product.all') }}';
