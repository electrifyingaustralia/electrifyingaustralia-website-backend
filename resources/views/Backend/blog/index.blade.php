...
<div class="flex-1 p-3">
    <div class="max-w-[90rem] mx-auto">
        <div class="flex justify-between items-center mb-5" aria-label="Breadcrumb">
            ...
            <a href="{{ route('admin.blog.create') }}" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg">
        ...
        <div class="bg-white p-4 rounded-lg shadow mb-6">
            <form action="{{ route('admin.blog.all') }}" method="GET">
                <div class="flex gap-4">
                    <div class="flex-1">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search blogs title or subtitle..." class="w-full p-2 border !border-gray-300 rounded-lg">
                    </div>
                    ...
                    @forelse($blogs  as $blog)
                        ...
                        <tr>
                            <td class="px-6 py-4 font-medium text-gray-900 max-w-[2rem]">
                                <div class="flex items-center">
                                    @if($blog->media_url)
                                    <img src="{{ $blog->media_url }}" class="w-20 h-10 object-scale-down rounded">
                                    @else
                            ...
                            <td class="px-6 py-8 flex gap-x-2">
                                ...
                                <button class="text-red-500 hover:text-red-700" type="button" onclick="confirmDelete({{ $blog->id }})">
