        ...
        <div class="bg-white p-4 rounded-lg shadow mb-6">
            <form action="{{ route('admin.blog.all') }}" method="GET">
                <div class="flex gap-4">
                    <div class="flex-1">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search blogs..." class="w-full p-2 border !border-gray-300 rounded-lg">
                    </div>
                    ...
                    @forelse($blogs  as $blog)
                        ...
                        <tr>
                            <td class="px-6 py-4 font-medium text-gray-900 max-w-[2rem]">
                                <div class="flex items-center">
                                    @if($blog->media_url)
                                    <img src="{{ $blog->media_url }}" class="w-20 h-10 object-cover rounded">
                                    @else
