                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2">All Blog Categories</span>
                        </div>
                    </li>
                </ol>
            </div>
                                    ...
                                    @forelse($categories as $category)
                                        <tr>
                                            ...
                                            <td class="px-14 py-4 flex justify-end gap-x-2">
                                                <a href="{{ route('admin.blog-category.edit', $category->id) }}" class="text-blue-500 hover:text-blue-700 p-1 rounded hover:bg-blue-50">
                                        ...
                                        <tr>
                                            <td colspan="2" class="px-6 py-4 text-center font-medium text-gray-700">
                                                <div class="flex flex-col items-center justify-center gap-x-4 py-2">
                                                    ...
                                                    <span class="pt-2 text-lg">No Blog Category found.</span>
                                                </div>
                                                <span class="text-gray-500">Create your first blog category to get started!</span>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
                ...
                <div class="w-full lg:!w-1/3">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h2 class="text-xl font-semibold mb-4 text-gray-800 border-b pb-2">
                            {{ isset($categoryToEdit) ? 'Edit Blog Category' : 'Add New Blog Category' }}
                        </h2>

                        <form action="{{ isset($categoryToEdit) ? route('admin.blog-category.update', $categoryToEdit->id) : route('admin.blog-category.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $categoryToEdit->name ?? '') }}"
                                    ...
                                    placeholder="Enter your blog category here..."
                                />
                                @error('name')
                            ...
                            <div class="flex justify-end mt-6">
                                @if(isset($categoryToEdit))
                                    <a href="{{ route('admin.blog-category.all') }}" class="px-4 py-2 border !border-gray-300 rounded-lg text-gray-700 hover:!bg-gray-50 mr-2">
                                        Cancel
                                    </a>
                                @endif
                                <button type="submit" class="px-4 py-2 !bg-teal-600 text-white rounded-lg hover:!bg-teal-700">
                                    {{ isset($categoryToEdit) ? 'Update' : 'Create' }} Blog Category
                                </button>
                            </div>
                        </form>
                    </div>
