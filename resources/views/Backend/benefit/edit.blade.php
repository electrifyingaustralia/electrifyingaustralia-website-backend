...
@section('contents')
    <div class="flex-1 p-6">
        <div class="max-w-5xl mx-auto">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page" class="hidden lg:block">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ml-1 text-lg font-medium text-gray-500 md:ml-2 truncate lg:!max-w-[15rem]">{{ $benefit->title }}</span>
                        </div>
                    </li>
                </ol>
            ...
            <form id="benefit-form" action="{{ route('admin.benefit.update', $benefit->id) }}" method="POST"
                    ...
                    <div class="w-full">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    <label for="title" class="block text-sm font-medium text-gray-700 mb-2">Benefit title
                                    ...
                                    <input type="text" id="title" name="title" required
                                        ...
                                        value="{{ old('title', $benefit->title) }}" placeholder="Enter benefit title" />
                                    @error('title')
                                ...
                                <div>
                                    <label for="subtitle" class="block text-sm font-medium text-gray-700 mb-2">Benefit
                                        Subtitle</label>
                                ...
                                <div>
                                    <label for="bold_info" class="block text-sm font-medium text-gray-700 mb-2">Benefit Bold
                                        Info</label>
                                    <input type="text" id="bold_info" name="bold_info"
                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                                ...
                                <div>
                                    <label for="is_active" class="block text-sm font-medium text-gray-700 mb-1">Benefit
                                        Status</label>
                                    <select name="is_active" id="is_active"
                                        class="w-full p-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500">

                                        <option value="1"
                                            {{ old('is_active', $benefit->is_active) == 1 ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="0"
                                            {{ old('is_active', $benefit->is_active) == 0 ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
                                </div>
                                    ...
                                    <div class="flex flex-col sm:flex-row gap-4">
                                        ...
                                        <div class="w-32 h-32 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-gray-50"
                                            ...
                                            @if ($benefit->media)
                                                @if ($benefit->media->mime_type && str_starts_with($benefit->media->mime_type, 'image/'))
                                                    <img src="{{ $benefit->media->url }}" alt="{{ $benefit->title }}"
                                        ...
                                        <div class="flex flex-col justify-center gap-2">
                                            ...
                                            <input type="hidden" id="selected-media-id" name="media_id"
                                                value="{{ old('media_id', $benefit->media_id) }}">
                                        </div>
                                    </div>

                                    <!-- Selected Media Info -->
                                    <div id="selected-logo-info"
                                        class="mt-3 p-3 bg-gray-50 rounded-lg {{ $benefit->media ? '' : 'hidden' }}">
                                        @if ($benefit->media)
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center space-x-3">
                                                    @if ($benefit->media->mime_type && str_starts_with($benefit->media->mime_type, 'image/'))
                                                        <img id="selected-logo-preview" src="{{ $benefit->media->url }}"
                                                    ...
                                                    <div>
                                                        <p id="selected-logo-name" class="text-sm font-medium">
                                                            {{ $benefit->media->original_name }}</p>
                                                        <p id="selected-logo-size" class="text-xs text-gray-500">
                                                            {{ formatFileSize($benefit->media->file_size) }}</p>
                                                    </div>
                                                </div>
