...
<div class="flex-1 p-3">
    <div class="max-w-[90rem] mx-auto">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2">All Benefits</span>
                    </div>
                </li>
            </ol>
            <a href="{{ route('admin.benefit.create') }}" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg">
        ...
        <div class="bg-white p-4 rounded-lg shadow mb-6">
            <form action="{{ route('admin.benefit.all') }}" method="GET">
                <div class="flex gap-4">
                    <div class="flex-1">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search benefits..." class="w-full p-2 border !border-gray-300 rounded-lg">
                    </div>
                        ...
                        <tr>
                            <td class="px-6 py-4 font-medium text-gray-900 max-w-[2rem]">
                                <div class="flex items-center">
                                    ...
                                    <img src="{{ $benefit->media_url }}" class="w-20 h-10 object-scale-down rounded">
                                    @else
                            ...
                            <td class="px-6 py-4 max-w-[15rem] truncate">{{ $benefit->title }}</td>
                            <td class="px-6 py-4 max-w-[15rem] truncate">{{ $benefit->subtitle }}</td>
                            <td class="px-6 py-4">
                                @if($benefit->is_active == 1)
                            ...
                            <td class="px-6 py-8 flex gap-x-2">
                                <a href="{{ route('admin.benefit.edit', $benefit->id) }}" class="text-blue-500 hover:text-blue-700">
                                ...
                                <button class="text-red-500 hover:text-red-700" type="button" onclick="confirmDelete({{ $benefit->id }})">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center font-medium text-gray-700">
                                <div class="flex flex-col items-center justify-center gap-x-4 py-2">
                                    ...
                                    <span class="pt-2 text-lg">No Benefit found.</span>
                                </div>
...
<div id="delete-modal" class="fixed inset-0 bg-black/30 bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white p-6 rounded-lg w-full max-w-md">
        ...
        <p class="text-gray-600 mb-6">Are you sure you want to delete this benefit? This action cannot be undone.</p>
