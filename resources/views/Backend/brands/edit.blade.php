    ...
    <div class="flex-1 p-6">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="bg-white p-6 rounded-lg shadow">
                <form id="brand-form" action="{{ route('admin.brands.update', $brand->id) }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <!-- Brand Name -->
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Brand Name <span
                                    class="text-red-600 font-bold">*</span></label>
                            <input type="text" id="name" name="name" value="{{ old('name', $brand->name) }}"
                                required failed remove="name"
                        ...
                        <!-- Brand Link -->
                        <div>
                            <label for="link" class="block text-sm font-medium text-gray-700 mb-2">Website Link <span
                                    class="text-red-600 font-bold">*</span></label>
                            <input type="url" id="link" name="link" value="{{ old('link', $brand->link) }}"
                                required failed remove="link"
                                class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                        ...
                        <!-- Media Selection -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Brand Logo <span
                                    class="text-red-600 font-bold">*</span></label>
                            ...
                            <div id="selected-logo-info"
                                class="mt-3 p-3 bg-gray-50 rounded-lg {{ $brand->logo ? '' : 'hidden' }}">
                                @if ($brand->logo)
