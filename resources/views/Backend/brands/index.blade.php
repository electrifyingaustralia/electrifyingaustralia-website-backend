            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2">All Brands</span>
                    </div>
                </li>
            </ol>
            <a href="{{ route('admin.brands.create') }}" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg">
        ...
        <div class="bg-white p-4 rounded-lg shadow mb-6">
            <form action="{{ route('admin.brands.all') }}" method="GET">
                <div class="flex gap-4">
                    <div class="flex-1">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search brands..." class="w-full p-2 border !border-gray-300 rounded-lg">
                    </div>
                    ...
                    @forelse($brands as $brand)
                        <tr>
                            <td class="px-6 py-4 font-medium text-gray-900">
                                <div class="flex items-center">
                                    @if($brand->logo_url)
                                    <img src="{{ $brand->logo_url }}" alt="{{ $brand->name }}" class="w-20 object-cover rounded">
                                    @else
                                        <div class="w-20 bg-gray-200 rounded flex items-center justify-center">
                            ...
                            <td class="px-6 py-8 flex gap-x-2">
                                ...
                                <button class="text-red-500 hover:text-red-700" type="button" onclick="confirmDelete({{ $brand->id }})">
