                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2">All Users</span>
                        </div>
                    </li>
                </ol>
                        ...
                        @forelse($admins as $admin)
                            <tr>
                                <td class="px-6 py-4 font-medium text-gray-900">
                                    <div class="flex items-center">
                                        @if($admin->media_url)
                                            <img class="h-10 w-10 rounded-full object-scale-down mr-3"
                                                src="{{ $admin->media_url }}"
                                                alt="{{ $admin->name }}">
                                        @else
                                ...
                                <td class="px-6 py-8 flex gap-x-2">
                                    ...
                                    <button class="text-red-500 hover:text-red-700" type="button" onclick="confirmDelete({{ $admin->id }})">
