...
<div class="flex-1 p-3">
    <div class="max-w-[90rem] mx-auto">
        <div class="flex justify-between items-center mb-5" aria-label="Breadcrumb">
            ...
            <a href="{{ route('admin.project.create') }}" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg">
        ...
        <div class="bg-white p-4 rounded-lg shadow mb-6">
            <form action="{{ route('admin.project.all') }}" method="GET">
                <div class="flex gap-4">
                    <div class="flex-1">
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search projects..." class="w-full p-2 border !border-gray-300 rounded-lg">
                    </div>
                            ...
                            <tr class="">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        @if($project->media_url)
                                            <img src="{{ $project->media_url }}" alt="{{ $project->title }}" class="w-16 h-12 object-scale-down rounded-lg border border-gray-200">
                                        @else
                                ...
                                <td class="px-6 py-4">
                                    <div class="max-w-[200px]">
                                        <span class="font-medium text-gray-900 line-clamp-2">{{ $project->title }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="max-w-[200px]">
                                        ...
                                        <a href="{{ route('admin.project.show', $project->id) }}"
                                           ...
                                           title="View">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                                                <path d="M12 5c-7.633 0-11 7-11 7s3.367 7 11 7 11-7 11-7-3.367-7-11-7zm0 12c-4.411 0-7.757-3.134-9.223-5 1.466-1.866 4.812-5 9.223-5s7.757 3.134 9.223 5c-1.466 1.866-4.812 5-9.223 5z"/>
