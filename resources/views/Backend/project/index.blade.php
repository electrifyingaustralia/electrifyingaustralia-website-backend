                        ...
                        <tr>
                            <td class="px-6 py-4 font-medium text-gray-900 max-w-[2rem]">
                                <div class="flex items-center">
                                    ...
                                    <img src="{{ $project->media_url }}" class="w-20 h-10 object-scale-down rounded">
                                    @else
                            ...
                            <td class="px-6 py-8 flex gap-x-2">
                                ...
                                <button class="text-red-500 hover:text-red-700" type="button" onclick="confirmDelete({{ $project->id }})">
