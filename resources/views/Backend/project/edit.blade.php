                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                <label for="type" class="block text-sm font-medium text-gray-700 mb-1">
                                    Project Type <span class="text-red-600">*</span>
                                </label>
                                <select name="type" id="type"
                                    class="w-full p-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500">
                                    <option value="commercial" {{ old('type', $project->type ?? '') == 'commercial' ? 'selected' : '' }}>
                                        Commercial
                                    </option>
                                    <option value="residential" {{ old('type', $project->type ?? '') == 'residential' ? 'selected' : '' }}>
                                        Residential
                                    </option>
                                </select>
                            </div>
