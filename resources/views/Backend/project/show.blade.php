            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                            ...
                            <div class="bg-gray-100 rounded-lg overflow-hidden">
                                <img src="{{ $imageUrl }}" alt="Project Image" class="w-full h-32 object-scale-down">
                            </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="md:col-span-1">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="mb-4">
                            <img src="{{ $project->media_url }}" alt="{{ $project->title }}" class="w-full h-48 object-fit rounded-lg">
                        </div>
                        @endif
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-200 space-y-2">
                            <a href="{{ route('admin.project.edit', $project->id) }}" class="w-full bg-teal-600 hover:bg-teal-700 text-white py-2 px-4 rounded-lg flex items-center justify-center">
                            ...
                            <a href="{{ route('admin.project.assign-images', $project->id) }}" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-2">
