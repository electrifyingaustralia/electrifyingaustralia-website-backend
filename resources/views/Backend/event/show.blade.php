            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2">View Event</span>
                    </div>
                </li>
            </ol>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="md:col-span-2">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-gray-600 mb-1">{{ $event->subtitle }}</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="text-gray-700 bg-gray-50 p-4 rounded-lg">
                            {!! $event->description ?? '<span class="text-gray-400">No description available</span>' !!}
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                            ...
                            <div class="bg-gray-100 rounded-lg overflow-hidden">
                                <img src="{{ $imageUrl }}" alt="Event Image" class="w-full h-32 object-scale-down">
                            </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="md:col-span-1">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        @if($event->media_url)
                        <div class="mb-4">
                            <img src="{{ $event->media_url }}" alt="{{ $event->title }}" class="w-full h-48 object-fit rounded-lg">
                        </div>
                        @endif
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-800">{{ formatDate($event->created_at) }}</p>
                            </div>

                            <div>
                                <p class="text-sm text-gray-600">Last Updated</p>
                                <p class="text-gray-800">{{ formatDate($event->updated_at) }}</p>
                            </div>
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-200 space-y-2">
                            <a href="{{ route('admin.event.edit', $event->id) }}" class="w-full bg-teal-600 hover:bg-teal-700 text-white py-2 px-4 rounded-lg flex items-center justify-center">
                            ...
                            <a href="{{ route('admin.event.assign-images', $event->id) }}" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-2">
