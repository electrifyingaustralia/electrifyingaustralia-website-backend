            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li aria-current="page" class="hidden lg:block">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2 truncate lg:!max-w-[15rem]">{{$event->title}}</span>
                    </div>
                </li>
            </ol>
                ...
                <div class="w-full lg:!w-2/3">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                <label for="subtitle" class="block text-sm font-medium text-gray-700 mb-2">Event Subtitle <span class="text-red-600">*</span></label>
                                <input
                                ...
                                <div class="flex flex-col sm:flex-row gap-4">
                                    ...
                                    <div class="w-32 h-32 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-gray-50" id="logo-preview">
                                        @if($event->media)
                                            ...
                                            @else
                                                @php
                                                    $fileExtension = pathinfo($event->media->original_name, PATHINFO_EXTENSION);
                                                    $bgColor = 'bg-gray-200';
                                                    $iconSvg = '';
                                    ...
                                    <div class="flex flex-col justify-center gap-2">
                                        ...
                                        <input type="hidden" id="selected-media-id" name="media_id" value="{{ old('media_id', $event->media_id) }}">
                                    </div>
                                </div>
