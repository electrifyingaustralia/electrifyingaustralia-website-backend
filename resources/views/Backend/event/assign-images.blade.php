...
<div class="flex-1 p-6">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-5" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('admin.event.all') }}" class="ml-1 text-lg font-medium text-gray-极0 hover:!text-teal-600 md:ml-2">Events</a>
                    </div>
                </li>
            ...
            <a href="{{ route('admin.event.all') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg">
        ...
        <div class="bg-white p-6 rounded-lg shadow mb-6">
            ...
            <form id="assign-images-form" action="{{ route('admin.event.store-images', $event->id) }}" method="POST">
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('admin.event.all') }}" class="!bg-gray-600 hover:!bg-gray-700 text-white px-6 py-2 rounded-lg">
                        Cancel
                    </a>
