...
<div class="flex-1 p-3">
    <div class="max-w-[90rem] mx-auto">
        <div class="flex justify-between items-center mb-5" aria-label="Breadcrumb">
            ...
            <a href="{{ route('admin.teams.create') }}" class="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2 rounded-lg">
                    ...
                    @forelse($teams as $team)
                        <tr>
                            ...
                            <td class="px-6 py-8 flex gap-x-2">
                                ...
                                <button class="text-red-500 hover:text-red-700" type="button" onclick="confirmDelete({{ $team->id }})">
