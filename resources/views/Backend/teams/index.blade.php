...
@section('contents')
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-lg font-medium text-gray-500 md:ml-2">All Team Members</span>
                        </div>
                    </li>
                </ol>
                <div class="flex gap-2">
                    <button id="save-order-btn"
                        class="!bg-[#006494] hover:!bg-[#003554] !text-white px-4 py-2 rounded-lg hidden">
                    ...
                    <table class="min-w-full text-sm text-left text-gray-600">
                        ...
                        <tbody id="sortable-table" class="divide-y divide-gray-200">
                            @forelse($teams as $team)
                                <tr data-id="{{ $team->id }}" class="cursor-move hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center text-gray-400">
                                            ...
                                            <span class="ml-2 text-gray-600">{{ $team->order }}</span>
                                        </div>
                                    </td>
    ...
    <div id="delete-modal" class="fixed inset-0 bg-black/30 bg-opacity-50 flex items-center justify-center hidden z-50">
        <div class="bg-white p-6 rounded-lg w-full max-w-md">
            ...
            <p class="text-gray-600 mb-6">Are you sure you want to delete this Team Member? This action cannot be undone.
            </p>
