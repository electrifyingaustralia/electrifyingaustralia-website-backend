                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="status" id="status" class="w-full p-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500">
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    localStorage.setItem('toastr_success', response.message) || '{{ route('admin.teams.all') }}';
